...
#  
# # # 12121212121212112121212121212121212121212121212
# # 
# # 
# # 
# # class Patsient:
...
# #        
# # class Record:
# #     def __init__(self,patsiendiNimi,arstiNimi,viisitiAega):
# #         self.patsiendiNimi = patsiendiNimi
# #         self.arstiNimi = arstiNimi
# #         self.viisitiAega = viisitiAega
# #        
# #        
# # class Haigla:
# #     def __init__(self):
...
# #                 patsiendiInput = input("Sisesta patsienti nimi")
# #                
# #                 if userInput in elem.aeg:
# #                     elem.aeg.remove(userInput)
# #                     for elem2 in self.patsiendiList:
# #                         if elem2.nimi in patsiendiInput:
# #                             record = Record(patsiendiInput,sisestatudArstiNimi,userInput)
# #                             self.recordList.append(record)
# #                             print("Record oli loodud")
# #                             print(self.recordList)
# #                 else:
# #                     print("andmed oli isestatud valesti")
# #                
# #                
# #    
# #     def naitaPatsiendid(self):
# #         for index,elem in enumerate(self.patsiendiList):
# #             print("id: ", index, "Patsiendi nimi: ",elem.nimi,'vanus: ',elem.vanus)
# # 
# #    
# #    
# #            
# # pats1 = Patsient("Thomas",88)
# # pats2 = Patsient("Alex",75)
# # arst1 = Arst("Muhamed",34,"Kiirurg",['10:00','11:00'])
# # arst2 = Arst("Michael",23,"Pere arst",['12:00','14:00'])
# # haigla = Haigla()
...
class Monkey:
    ...
    def eat(self):
        print(f"{self.name} the Monkey is eating.")

    def makeSound(self):
        print(f"{self.name} the Monkey makes a funny sound!")
...
class Penguin:
    ...
    def eat(self):
        print(f"{self.name} the Penguin is eating.")

    def makeSound(self):
        print(f"{self.name} the Penguin makes a honking sound!")
...
monkey = Monkey("George", 25, 3)
monkey.performActions()

elephant = Elephant("Dumbo", 5000, 10)
elephant.performActions()

penguin = Penguin("Penny", 10, 2)
penguin.performActions()


Leo the Lion is eating.
Leo the Lion roars!
George the Monkey is eating.
George the Monkey makes a funny sound!
Dumbo the Elephant is eating.
Dumbo the Elephant trumpets!
Penny the Penguin is eating.
Penny the Penguin makes a honking sound!
